	...
	config(){
		var ui = {
			...
			columns: [
				...
				{id: "comments", header: "Comments", footer: "regularoffersgrid", fillspace: 1.25, editor: "custommultiselect", options: [{id:1, check: 0, status: "Landed"}, {id:2, check: 0, status: "On Time"}], template: function(obj) {
					let className = "";
