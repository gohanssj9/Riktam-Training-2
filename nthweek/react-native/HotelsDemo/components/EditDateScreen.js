    ...
    return (
       <Container>
        ...
        <Content style = {{backgroundColor: '#E8E8E8', marginTop: 7}}>
          <TouchableWithoutFeedback onPress = {() => {this.props.navigation.navigate('Calendar')}}>
              ...
              <View style = {{flex: 1, marginLeft: 3, backgroundColor: 'white', borderRadius: 5, elevation: 3}}>
                ...
                <View style = {{flex: 2,}}>
                  <View style = {{padding: 11, paddingLeft: 15}}>
                    ...
                    <Text style = {{fontSize: 14, color: '#156BC1'}}>03-Nov-2018</Text>
        ...
        <Footer height = {47}>
          <FooterTab>
            <Button full style = {{backgroundColor: '#156BC1'}} onPress = {() => {this.props.navigation.goBack()}}>
